# Full Stack -websovelluskehitys harjoitustyö 5, 7 tai 10 op (Viimeksi päivitetty 7.3.)

**Lue alla olevat ohjeet huolella läpi.**
...
Projektissa on sallittua käyttää generatiivisia malleja koodauksen ja dokumentaation luonnin tukena. **Lisää READMEhin selvitys mihin ja mitä mallia käytit.**

Lisäksi, jos jokin tiedosto on kokonaan tai lähes kokonaan generoitu, niin merkitse se selkeästi tiedoston alkuun. Haluamme antaa ensisijaisesti palautetta itse tehdystä, emmekä generoidusta työstä. Esim:
...
- Projektirepositoriosi **README-tiedostosta tulee löytyä** seuraavat asiat:
  - Linkki osoitteeseen, jossa sovelluksesi on käynnissä. Expolla toteutetun React Native mobiilisovelluksen kohdalla repositoriossa tulee olla [QR-koodi](https://courses.mooc.fi/org/uh-cs/courses/full-stack-open-react-native/chapter-5), jonka kautta sovelluksen voi käynnistää Expon mobiilisovelluksessa. Muissa tapauksissa sovitaan sovelluksen demoamisesta tapauskohtaisesti
  ...
  - Selvitys tekoälyn käytöstä (katso kohta Generatiivisten kielimallien käyttö)
...
(1) Ilmoittaudu oikean kokoiseen kurssiin:

- FS harjoitustyö (5 op): <https://sisu.helsinki.fi/student/courseunit/otm-ecc4bc8e-938f-4af2-b9a3-f71533ed2732/open-university/otm-5fdedfae-a087-42d8-be7a-71437e99bfe8?token=V92HDDUZSJ>
- FS harjoitustyö (7 op): <https://sisu.helsinki.fi/student/courseunit/otm-3ccee448-b666-4c82-a721-8a020dab095a/open-university/otm-4a271d2e-8c6c-4ad2-b522-9bc0dcc203c9?token=F7EADTZAXG>
- FS harjoitustyö (10 op): <https://sisu.helsinki.fi/student/courseunit/otm-2cefe17b-6903-4eff-b093-494f1b88ff8a/open-university/otm-1afb7a39-0ee6-4854-ad17-9722f2749a15?token=LQPD9XZDTX>
